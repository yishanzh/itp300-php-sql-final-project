...
//Select all clothings for displaying purposes.
$sql_all_clothings = "SELECT * 
                      FROM product
                      WHERE product.category_id = 1;";
$results_all_clothings = $mysqli->query($sql_all_clothings);
if ($results_all_clothings == false ) {
  echo $mysqli->error;
  exit();
}
...
<div id="product">
    ...
    <p class="text-center">衣 | C L O T H I N G S</p>

  <div class="row" style="margin: 5%;" >

   <?php
   $index = 0;
   while( $row = $results_all_clothings->fetch_assoc() ):
   ?>
