...
<ul class="navbar-nav">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="shoes.php">Shoes  <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<form action="shoes_results.php?" method="GET">
...
<div id="product">
    ...
    <p class="text-center">鞋 | S H O E S</p>
  ...
  <div class="row" style="margin: 5%;" >
   ...
   <?php
   $index = 0;
   while( $row = $results_all->fetch_assoc() ):
   ?>
